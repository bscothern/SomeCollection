...
//            "EnumeratedSequence.Iterator",
            ...
            .init(name: "StrideThrough", excluding: ["Bool", "Error", "String", "Substring", "Character", "Unicode.Scalar"], skipOptional: true),
            .init(name: "StrideTo", excluding: ["Bool", "Error", "String", "Substring", "Character", "Unicode.Scalar"], skipOptional: true),
            "UnfoldSequence",
            "UnsafeBufferPointer",
